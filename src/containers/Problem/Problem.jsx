                ...
                <div className="InnerProblem">
                    <div className="Double">
                        ...
                        <div className="Right Column">
                            ...
                            <p>I och med att fler folk väljer att flytta närmare städer. Detta leder till att <strong>en stor del av Husqvarnas kundgrupp över tid kommer att försvinna</strong>. I detta fallet blir levande grönområden allt viktigare.</p>
                            ...
                            <p>Vi har tittat på <strong>nya distrubitionssätt</strong> och byggt ett koncept för att engagera fler folk i socialt trädgårdsarbete.</p>
                        </div>
                    </div>
                </div>
			</div>
