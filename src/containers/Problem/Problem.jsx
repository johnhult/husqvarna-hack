                ...
                <div className="InnerProblem">
                    <div className="Double">
                        ...
                        <div className="Right Column">
                            ...
                            <p>Allt fler människor väljer att flytta närmare städer. Detta leder till att <strong>en stor del av Husqvarnas kundgrupp över tid kommer att försvinna</strong>. I detta fallet blir levande grönområden allt viktigare.</p>
                            ...
                            <p>Avsaknad av parker och flora kan leda till flertalet stressrelaterade problem. En blomma i fönstret räcker inte. Hur kan vi hitta <strong>nya sätt att distribuera</strong> och samtidigt få personer att må bättre?</p>
                            <p>Vi har tittat på <strong>nya distributionssätt</strong> och byggt ett koncept för att engagera fler individer i socialt trädgårdsarbete.</p>
                        </div>
                    </div>
                </div>
			</div>
